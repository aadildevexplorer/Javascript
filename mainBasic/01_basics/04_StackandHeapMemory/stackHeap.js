// Stack (Interview Definition)

// 👉
// “Stack is a memory region used to store primitive data types and function execution contexts. It follows LIFO (Last In First Out) and stores values directly.”

// 🔑 Key Points bolne ke liye:
// Primitive values store hoti hain (number, string, boolean, null, undefined, symbol)
// Fast access
// Fixed size
// Value copy hota hai
// 🔥 Heap (Interview Definition)

// 👉
// “Heap is a memory region used to store reference data types like objects, arrays, and functions. It stores data dynamically and variables hold references (addresses) to these values.”

// 🔑 Key Points:
// Objects, arrays, functions store hote hain
// Dynamic memory allocation
// Slow compared to stack
// Reference (address) store hota hai
