...
// 👉 Jab ek hi value ko baar-baar compare karna ho, tab switch–case
//  if–else se zyada clean aur readable hota hai.
...
if (age >= 20) {
  console.log("I am eligible for drive the car");
} else {
  console.log("I am not eligibe");
}
